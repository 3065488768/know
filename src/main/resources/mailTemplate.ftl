        ...
        <tr>
            <td style="word-break:break-all">
                <div style="padding:25px 35px 40px; background-color:#fff;opacity:0.8;">
                    ...
                    <!-- 中文 -->
                    <p>您好！此邮件来自知著图书论坛，您的账号需要进行邮箱验证来完成操作，验证码为：<font color="#ff8c00">{0}</font>，有效期5分钟，请尽快填写验证码完成验证！</p>
                    <br>
                    <!-- 英文 -->
                    <h2 style="margin: 5px 0px; ">
                        <font color="#333333" style="line-height: 20px; ">
                    ...
                    <p>Hello! This email is from Zhizhu Books Forum. Your account needs to be verified by email to
                        complete registration, the
                        verification code is:<font color="#ff8c00">{0}</font>, valid for 5 minutes. Please fill in the
