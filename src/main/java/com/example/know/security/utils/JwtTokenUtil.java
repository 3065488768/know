...
public class JwtTokenUtil {
    ...
    public String getUserNameFromHttpServletRequest(HttpServletRequest request, String requestHeader, int prefixLength) {
        String head = request.getHeader(requestHeader);
        if (StringUtils.hasLength(head)) {
            String token = head.substring(prefixLength);
            String username;
            try {
                Claims claims = getClaimsFromToken(token);
                username = claims.getSubject();
